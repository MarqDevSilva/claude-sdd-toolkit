...
> Template para `.spec/discovery/roadmap.md`. Estrutura usada pelo skill [`/app-kickoff`](../SKILL.md) na Fase 4.
...
- [ ] Setup do workspace (back + front, monorepo se aplicável)
...
- [ ] Observabilidade: Logback + Sentry + Actuator
- [ ] Error handling: `ErrorCode` + `DomainException` + handler global
