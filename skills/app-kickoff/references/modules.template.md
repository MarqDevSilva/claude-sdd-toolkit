...
> Template para `.spec/discovery/module_<nome>.md`. Estrutura usada pelo skill [`/app-kickoff`](../SKILL.md) na Fase 2.
...
> Termos novos que aparecem nas seções abaixo — anotar pra sugerir no glossário do projeto.
...
> Use o catálogo de NFRs do projeto como ponto de partida.
