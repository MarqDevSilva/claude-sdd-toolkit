...
> Template para `.spec/discovery/brief.md`. Estrutura usada pelo skill [`/app-kickoff`](../../.claude/skills/sdd/app-kickoff/SKILL.md) na Fase 1.
> Foundational, leve. Não inflar — detalhamento técnico mora em `modules.md`.
...
- **Stack pretendido**: linkar pra [tech-stack.md](../memory/tech-stack.md) ou anotar divergências.
...
- [ ] `project_stack.md` — divergências/escolhas vs `.spec/memory/tech-stack.md`
